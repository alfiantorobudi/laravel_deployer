...
// Project name
set('application', 'laravel_deployer');

// Project repository
set('repository', 'git@bitbucket.org:alfiantorobudi/laravel_deployer.git');
...
host('54.255.242.205')
    ...
    ->identityFile('~/.ssh/id_rsa')
    ->set('branch', 'master')
    ->set('deploy_path', '/opt/bitnami/apache2/htdocs/laravel_deployer');
